...
def _format_candidate_for_prompt(p: Pick, *, detail: str = "full") -> str:
    ...
    if detail == "compact":
        return (
            ...
            f"dividend_yield={p.dividend_yield_pct}%, debt_ratio={p.debt_ratio_pct}%, "
            f"float_market_cap={p.float_market_cap_cny}, financial_period={p.financial_report_period}, "
